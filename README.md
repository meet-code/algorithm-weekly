...
3. [Leetcode : 65. Valid Number](https://leetcode.com/problems/valid-number/)
...
3. [Leetcode : 805. Split Array With Same Average](https://leetcode.com/problems/split-array-with-same-average/)
...
2. [Leetcode : 1052. Grumpy Bookstore Owner](https://leetcode.com/problems/grumpy-bookstore-owner/)
3. [Leetcode : 483. Smallest Good Base](https://leetcode.com/problems/smallest-good-base/)
...
2. [Leetcode : 1785. Minimum Elements to Add to Form a Given Sum](https://leetcode.com/problems/minimum-elements-to-add-to-form-a-given-sum/)
3. [Leetcode : 2030. Smallest K-Length Subsequence With Occurrences of a Letter](https://leetcode.com/problems/smallest-k-length-subsequence-with-occurrences-of-a-letter/)
...
2. [Leetcode : 2279. Maximum Bags With Full Capacity of Rocks](https://leetcode.com/problems/maximum-bags-with-full-capacity-of-rocks/)
3. [Leetcode : 778. Swim in Rising Water](https://leetcode.com/problems/swim-in-rising-water/)
...
1. [Leetcode : 584. Find Customer Referee](https://leetcode.com/problems/find-customer-referee/)
2. [Leetcode : 1997. First Day Where You Have Been in All the Rooms](https://leetcode.com/problems/first-day-where-you-have-been-in-all-the-rooms/)
3. [Leetcode : 460. LFU Cache](https://leetcode.com/problems/lfu-cache/)
...
3. [Leetcode : 1383. Maximum Performance of a Team](https://leetcode.com/problems/maximum-performance-of-a-team/)
...
3. [Leetcode : 1601. Maximum Number of Achievable Transfer Requests](https://leetcode.com/problems/maximum-number-of-achievable-transfer-requests/)
...
3. [Leetcode : 818. Race Car](https://leetcode.com/problems/race-car/)
...
3. [Leetcode : The Skyline Problem](https://leetcode.com/problems/the-skyline-problem/)
...
3. [Leetcode : Poor Pigs](https://leetcode.com/problems/poor-pigs/)
...
3. [Leetcode : Number of Visible People in a Queue](https://leetcode.com/problems/number-of-visible-people-in-a-queue/)
...
3. [Leetcode : Word Search II](https://leetcode.com/problems/word-search-ii/)
...
3. [Leetcode : Minimum One Bit Operations to Make Integers Zero](https://leetcode.com/problems/minimum-one-bit-operations-to-make-integers-zero/)
...
3. [Leetcode : Minimize Deviation in Array](https://leetcode.com/problems/minimize-deviation-in-array/)
...
3. [Leetcode : Trips and Users](https://leetcode.com/problems/trips-and-users/)
...
3. [Leetcode : Maximum Genetic Difference Query](https://leetcode.com/problems/maximum-genetic-difference-query/)
...
* [Leetcode : Minimum Number of Taps to Open to Water a Garden](https://leetcode.com/problems/minimum-number-of-taps-to-open-to-water-a-garden/)
...
* [Leetcode : Reaching Points](https://leetcode.com/problems/reaching-points/)
...
* [Leetcode : Arithmetic Slices II - Subsequence](https://leetcode.com/problems/arithmetic-slices-ii-subsequence/)
